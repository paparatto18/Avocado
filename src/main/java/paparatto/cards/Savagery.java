...
public class Savagery extends AbstractAvocadoCharacterCard {

    public static final String ID = Avocado.makeID("Savagery");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new SavageryPower(p, 1), 1));
    }
}