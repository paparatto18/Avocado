...
import paparatto.powers.RecombinationPower;
import paparatto.powers.SavageryPower;

public class Recombination extends AbstractAvocadoCharacterCard {

    public static final String ID = Avocado.makeID("Recombination");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new RecombinationPower(p, 1), 1));
    }
}