...
import paparatto.powers.ElectroplatingPower;

public class Electroplating extends AbstractAvocadoCharacterCard {

    public static final String ID = Avocado.makeID("Electroplating");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new ElectroplatingPower(p, this.magicNumber), this.magicNumber));
    }
}