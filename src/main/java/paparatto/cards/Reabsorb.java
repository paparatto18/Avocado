...
public class Reabsorb extends AbstractAvocadoCharacterCard {

    public static final String ID = Avocado.makeID("Reabsorb");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new ReabsorbPower(p, this.magicNumber), this.magicNumber));
    }
}