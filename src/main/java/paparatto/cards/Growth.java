...
public class Growth extends AbstractAvocadoCharacterCard {

    public static final String ID = Avocado.makeID("Growth");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new GrowthPower(p, this.magicNumber), this.magicNumber));
