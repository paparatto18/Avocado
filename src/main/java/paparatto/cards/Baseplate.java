...
public class Baseplate extends AbstractAvocadoCharacterCard {

    public static final String ID = Avocado.makeID("Baseplate");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        act(new ApplyPowerAction(p, p, new OrichalcumPower(p, this.magicNumber), this.magicNumber));
    }
}