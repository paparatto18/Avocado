...
import paparatto.actions.LunacyAction;
import paparatto.actions.WrapAction;

public class Lunacy extends AbstractAvocadoCharacterCard {

    public static final String ID = Avocado.makeID("Lunacy");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
       ...
       act( new LunacyAction(p, this.upgraded, this.freeToPlayOnce, this.energyOnUse));
    }
}