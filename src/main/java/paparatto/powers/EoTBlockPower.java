...

{
    ...
    public EoTBlockPower(AbstractCreature owner)
    {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("pits/images/powers/DelayedAttackBig.png"), 0, 0, 84, 84);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("pits/images/powers/DelayedAttack.png"), 0, 0, 32, 32);
    }
